# Milestone status: Milestone 2B — K-means static clustering (smoke)

| Field | Value |
|-------|-------|
| Status | PASS |
| Experiment id | baseline.cluster.kmeans_recovery_smoke |
| Manifest schema | 1 |
...
`/Users/jainendra/Documents/Cursor/ESL/manuscript_bundle/reports/milestone_2b_kmeans/artifacts`
