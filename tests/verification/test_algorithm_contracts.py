"""Contracts aligned with ALGORITHM.md — Current implementation (recovery vs adaptation, batch w=0, K cycling)."""
...
def test_v12_batch_appends_w_zero_and_dilutes_mean_gradient():
    ...
    in the denominator of the mean (ALGORITHM.md — prototype SGD).
    """
